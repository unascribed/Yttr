...
public class YItemGroups {
	...
	// TODO this entire system doesn't work on servers. why?
	...
	public static final ItemGroup PARENT = FabricItemGroupBuilder.create(new Identifier("yttr", "parent"))
		...
		.build()
		.hideName();
	public static final ItemGroup RESOURCES = PARENT;
	public static final ItemGroup FILTERING = PARENT;
	public static final ItemGroup MECHANISMS = PARENT;
	public static final ItemGroup EQUIPMENT = PARENT;
	public static final ItemGroup SNARE = PARENT;
	public static final ItemGroup LAMP = PARENT;
	public static final ItemGroup POTION = PARENT;
	public static final ItemGroup RUINED = PARENT;
	public static final ItemGroup MISC = PARENT;
...
//					group = FILTERING;
//				}
				((AccessorItem)i).yttr$setGroup(PARENT);
			}
		});
//		assign(RESOURCES,
//				YItems.GADOLINITE,
